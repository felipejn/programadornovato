			...
			<div class="row" style="box-shadow: 5px 5px 5px gray;">
				<div class="col-sm-12">
					...
					<div class="col-sm-12" style="padding-top: 2rem; padding-bottom: 2rem;">
						...
						<div style="font-family: 'Roboto Slab', serif; font-size: 18px; text-align: justify;"><?php echo $post["destext"]; ?></div>
						<?php if( isset($post["deslink"]) && $post["deslink"] != '' ){ ?><a href="<?php echo $post["deslink"]; ?>"
							style="font-family: 'Roboto Slab', serif; font-size: 18px;">Leia mais...</a><?php } ?>
