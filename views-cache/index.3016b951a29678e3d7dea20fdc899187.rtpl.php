	...
	<div class="row">
		...
		<div class="col-sm-8">
			...
			<div class="row" style="box-shadow: 5px 5px 5px gray;">
				<div class="col-sm-12">
					<!-- Title -->
					<h1 style="font-family: 'Bree Serif', serif; font-size: 30px;">SQL: Aprenda a utilizar a chave primária e a chave estrangeira</h1>
					<!-- Content Text -->
					<center><img class="img-responsive" width="500px" height="auto" style="margin: 2rem;" src="https://pplware.sapo.pt/wp-content/uploads/2017/12/mysql-720x415.jpg"></center>
			...
			<div class="row" style="box-shadow: 5px 5px 5px gray;">
				<div class="col-sm-12">
					<!-- Title -->
					<h1 style="font-family: 'Bree Serif', serif; font-size: 30px;">Guia prático para começar com o git sem preocupação</h1>
					<!-- Content Text -->
					<center><img class="img-responsive" width="500px" height="auto" style="margin: 2rem;" src="https://www.hostinger.com.br/tutoriais/wp-content/uploads/sites/12/2019/04/Como-Usar-Um-Git-Branch.png"></center>
					...
					criou esse guia prático para mostrar os comandos mais usados e suas funções.
					Clique aqui para ir para o </p>
